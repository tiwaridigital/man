...
import MANAGA_MUTATE from '../../graphql/adm/SingleMangaMutation.gql'
import MANGA_QUERY from '../../graphql/adm/SingleMangaQuery.gql'
...
const Page = () => {
    let he = {
        ...
        description: 'Akito Shirasawa, a high school boy whose father is a film director, sees something in the library preparation room. It was the "masturbation scene" of his classmate, Kaho Honjou. Akito is puzzled, but ends up filming it with his smartphone. Kaho notices Akito, and in the men\'s restroom, makes a "proposal" to Akito! Exposed high school girl and movie boy. The "exposed love" of twisted adolescence, begins!',
        coverImage:
